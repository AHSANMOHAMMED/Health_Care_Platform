      ...
      <div className="grid lg:grid-cols-3 gap-8">
               ...
               <div key={pharmacy.id} className="premium-glass p-8 group hover:border-indigo-200 transition-all cursor-pointer relative overflow-hidden">
                  <div className="flex flex-col md:flex-row justify-between gap-6">
                     <div className="flex gap-6">
                        ...
                        <div>
                           ...
                           <p className="text-slate-500 font-bold flex items-center gap-2 mb-3">
                              <MapPin size={16} className="text-slate-600" /> {pharmacy.address}
                           </p>
                           <div className="flex flex-wrap gap-4 text-xs font-black uppercase tracking-widest">
                              <span className="flex items-center gap-1.5 text-slate-600"><Navigation size={14}/> {pharmacy.distance}</span>
                              <span className="flex items-center gap-1.5 text-slate-600"><Clock size={14}/> {pharmacy.closingTime}</span>
                     ...
                     <div className="flex md:flex-col justify-end gap-3 min-w-[140px]">
                        <button className="flex-1 md:flex-none py-3 px-6 bg-slate-900 text-slate-900 rounded-xl font-bold text-sm shadow-xl hover:bg-indigo-600 transition-all active:scale-95">
                           Navigate
                        </button>
                        <div className="flex gap-2">
                           ...
                           <div className="p-3 bg-slate-50 text-slate-600 rounded-xl hover:text-slate-600 hover:bg-slate-100 transition-colors">
                              <Phone size={20} />
                           </div>
                        </div>
                     </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-slate-100 flex items-center justify-between">
                     <span className="text-xs font-black text-slate-600 uppercase tracking-widest">In-Stock Availability</span>
        ...
        <div className="space-y-8">
           <div className="premium-glass p-8 bg-slate-900 text-slate-900 relative overflow-hidden">
              ...
              <p className="text-slate-600 font-medium mb-8">Send your digital prescription directly to a nearby pharmacy for instant fulfillment.</p>
              <button className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-slate-900 font-black rounded-2xl transition-all shadow-xl text-lg flex items-center justify-center gap-2">
