          ...
          {!token ? (
              ...
              {status === 'success' ? (
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl bg-[#0EA5E9] hover:bg-[#0284C7] text-slate-900 font-semibold text-sm transition-all"
                  >
                    Back to Login
                  </button>
                </div>
                ...
                <>
                  <h1 className="text-xl font-bold text-slate-900 mb-1 text-center">Reset Password</h1>
                  ...
                  <form onSubmit={handleRequestReset} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-[#0EA5E9] hover:bg-[#0284C7] text-slate-900 font-semibold text-sm transition-all flex items-center justify-center gap-2 disabled:opacity-60"
                    >
                      {status === 'loading' ? (
            ...
            <>
              {status === 'success' ? (
                ...
                <>
                  <h1 className="text-xl font-bold text-slate-900 mb-1 text-center">Create New Password</h1>
                  <p className="text-sm text-slate-500 mb-6 text-center">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="••••••••"
                          minLength={8}
                          className="w-full bg-slate-50 border border-slate-300/50 rounded-xl py-3 pl-10 pr-10 text-sm text-slate-900 placeholder-slate-500 focus:outline-none focus:border-[#0EA5E9]/50 transition-colors"
                        />
                        <button
                          type="button"
